...
- [ ] Make stat cards clickable (Calls Made, Conversations, Appointments, Offers)
- [ ] Make Call Processing cards clickable (Queued, Scored, Skipped, Total)
- [ ] Navigate to Call History with appropriate filter applied
- [ ] Update Call History to accept filter parameters from URL


## Clickable Dashboard Stats
- [x] Make Dashboard stat cards clickable (Calls Made, Conversations, Appointments, Offers)
- [x] Make Call Processing cards clickable (Queued, Scored, Skipped, Total)
- [x] Add URL filter parameter handling to Call History page
- [x] Add Pending/Queued tab to Call History for in-progress calls
