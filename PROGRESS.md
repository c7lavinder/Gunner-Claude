...
**Owner action item carried forward from Session 78:**
...
manual work in the GHL UI**. Until those eight fields are deleted, GHL
remains the visible source of truth from the user's perspective even
though Gunner is now authoritative under the hood.
