...
export const LEVEL_THRESHOLDS = [
  ...
  { level: 2, minXp: 500, title: "Starter" },
  { level: 3, minXp: 1000, title: "Starter" },
  { level: 4, minXp: 1750, title: "Playmaker" },
  { level: 5, minXp: 2500, title: "Playmaker" },
  { level: 6, minXp: 4000, title: "All-Star" },
  { level: 7, minXp: 6000, title: "All-Star" },
  { level: 8, minXp: 9000, title: "Captain" },
  { level: 9, minXp: 12000, title: "Captain" },
  { level: 10, minXp: 15000, title: "Captain" },
  { level: 11, minXp: 20000, title: "MVP" },
  { level: 12, minXp: 27000, title: "MVP" },
  { level: 13, minXp: 35000, title: "Champion" },
  { level: 14, minXp: 42000, title: "Champion" },
  { level: 15, minXp: 50000, title: "Champion" },
  { level: 16, minXp: 62500, title: "Elite" },
  { level: 17, minXp: 77500, title: "Elite" },
  { level: 18, minXp: 95000, title: "Elite" },
  { level: 19, minXp: 110000, title: "Dynasty" },
  { level: 20, minXp: 125000, title: "Dynasty" },
  { level: 21, minXp: 150000, title: "Legend" },
  { level: 22, minXp: 180000, title: "Legend" },
  { level: 23, minXp: 220000, title: "GOAT" },
  { level: 24, minXp: 270000, title: "GOAT" },
...
export function getLevelFromXp(totalXp: number): { level: number; title: string; nextLevelXp: number; progress: number } {
  ...
  const progress = xpNeededForNextLevel > 0 ? Math.min(100, Math.round((xpInCurrentLevel / xpNeededForNextLevel) * 100)) : 100;
