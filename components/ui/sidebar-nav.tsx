...
import {
  ...
  Building2, BarChart3, Bot, Settings, ChevronRight, GraduationCap, Sun, Megaphone, DollarSign
} from 'lucide-react'
...
export function SidebarNav({ tenantSlug }: SidebarNavProps) {
  ...
  const navItems = [
    ...
    { href: `${base}/roi`, icon: DollarSign, label: 'Lead ROI', permission: 'kpis.view.all' as const },
