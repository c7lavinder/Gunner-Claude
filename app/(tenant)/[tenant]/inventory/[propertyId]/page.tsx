          ...
          include: {
            seller: {
              select: {
                ...
                email: true,
                ghlContactId: true,
                // v1.1 Wave 3 Phase B — surface backfilled Wave 1+2 fields on
                // the Property Research → Sellers sub-tab + render-side fallback
                // for the existing owner cards.
                ...
                motivationPrimary: true, motivationScore: true,
                likelihoodToSellScore: true, urgencyLevel: true,
                lastContactDate: true, totalCallCount: true,
                doNotContact: true, isDeceased: true,
              },
            },
          },
    ...
    <PropertyDetailClient
      property={{
        ...
        sellers: property.sellers.map((ps) => ({
          ...
          // v1.1 Wave 3 Phase B — backfilled fields for the Sellers sub-tab.
          firstName: ps.seller.firstName,
          middleName: ps.seller.middleName,
          lastName: ps.seller.lastName,
          nameSuffix: ps.seller.nameSuffix,
          skipTracedPhone: ps.seller.skipTracedPhone,
          skipTracedEmail: ps.seller.skipTracedEmail,
          skipTracedMailingAddress: ps.seller.skipTracedMailingAddress,
          skipTracedMailingCity: ps.seller.skipTracedMailingCity,
          skipTracedMailingState: ps.seller.skipTracedMailingState,
          skipTracedMailingZip: ps.seller.skipTracedMailingZip,
          seniorOwner: ps.seller.seniorOwner,
          deceasedOwner: ps.seller.deceasedOwner,
          cashBuyerOwner: ps.seller.cashBuyerOwner,
          totalPropertiesOwned: ps.seller.totalPropertiesOwned,
          ownerPortfolioTotalEquity: ps.seller.ownerPortfolioTotalEquity?.toString() ?? null,
          ownerPortfolioTotalValue: ps.seller.ownerPortfolioTotalValue?.toString() ?? null,
          ownerPortfolioAvgYearBuilt: ps.seller.ownerPortfolioAvgYearBuilt,
          motivationPrimary: ps.seller.motivationPrimary,
          motivationScore: ps.seller.motivationScore,
          likelihoodToSellScore: ps.seller.likelihoodToSellScore,
          urgencyLevel: ps.seller.urgencyLevel,
          lastContactDate: ps.seller.lastContactDate?.toISOString() ?? null,
          totalCallCount: ps.seller.totalCallCount,
          doNotContact: ps.seller.doNotContact,
          isDeceased: ps.seller.isDeceased,
        })),
