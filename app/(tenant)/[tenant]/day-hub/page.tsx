...
// Day Hub — fetches GHL tasks, classifies, scores, enriches.
// Canonical morning planner per CLAUDE.md Rule 3 § 7. Replaced /tasks page
// 2026-05-03 (Session 66) — old /tasks/ now redirects here for legacy bookmarks.
