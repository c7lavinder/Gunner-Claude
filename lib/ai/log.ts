...
interface AiLogParams {
  tenantId: string
  userId?: string | null
  type: 'assistant_chat' | 'call_grading' | 'deal_intel' | 'next_steps' | 'blast_gen' | 'buyer_scoring' | 'property_enrich' | 'action_execution' | 'property_story' | 'dispo_description' | 'dispo_listing' | 'dispo_social'
